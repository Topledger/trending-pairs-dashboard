...
const TrendingPairsDashboard: React.FC = () => {
  const [selectedDex, setSelectedDex] = useState<'pump-fun' | 'meteora-dbc' | 'raydium-launchlab' | 'letsbonk'>('pump-fun')
          ...
          <div className="border-b border-gray-800">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-4 pr-2">
                <select
                  value={selectedDex}
                  onChange={(e) => setSelectedDex(e.target.value as 'pump-fun' | 'meteora-dbc' | 'raydium-launchlab' | 'letsbonk')}
