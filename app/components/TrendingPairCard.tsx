...
const TrendingPairCard: React.FC<TrendingPairCardProps> = ({ pair }) => {
  ...
  const [copiedMint, setCopiedMint] = React.useState(false)
  ...
  let bundledWalletsPercentage = pair.metrics?.bundledWalletsPct || 0
  ...
  bundledWalletsPercentage = Math.min(bundledWalletsPercentage, 100)
  ...
  return (
    <div 
      className="bg-gray-950 border border-gray-800 p-2 rounded-xs transition-all duration-200 group cursor-pointer hover:border-blue-700/30 hover:scale-[1.02]"
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center justify-between"> 
            <div className="flex gap-3 text-sm">
              ...
              <div className="flex items-center gap-1" title="Bundled Wallets">
                ...
                <span className="text-white text-[11px]">{bundledWalletsPercentage.toFixed(0)}%</span>
              </div>
